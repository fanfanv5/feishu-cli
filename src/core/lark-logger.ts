...
function resolveRuntimeLogger(_subsystem: string): RuntimeLogger | null {
  // In standalone CLI mode, always use console fallback.
  // The openclaw runtime is not available.
  return null;
}
